...
const APP_TITLE = "ClaudePlane | AI-Native Project Management";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="ClaudePlane" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "ClaudePlane - AI-Native Project Management" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "ClaudePlane - AI-Native Project Management" },
];
