...
export const meta = () => [
  { title: "Glider | Project Management" },
  ...
  { property: "og:title", content: "Glider | Project Management" },
  {
  ...
  { property: "og:image:alt", content: "Glider - Project Management" },
  { name: "twitter:site", content: "@Glider" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Glider - Project Management" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Glider" />
