...
const APP_TITLE = "Glider Publish | Make your boards public with one-click";
const APP_DESCRIPTION = "Glider Publish is a feedback management tool built on Glider";
