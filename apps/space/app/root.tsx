...
const APP_TITLE = "ClaudePlane Publish | Make your boards public with one-click";
const APP_DESCRIPTION = "ClaudePlane Publish is a feedback management tool built on ClaudePlane";
